      ...
      <div className="items-container">
        ...
        <VerticalTimeline>
          <VerticalTimelineElement
            ...
            date="Summer 2026"
            iconStyle={{ background: '#0a90c0ff', color: 'rgb(39, 40, 34)' }}
            icon={<FontAwesomeIcon icon={faBriefcase} />}
          >
            <h3 className="vertical-timeline-element-title">Leadership Development Intern, IT & Cybersecurity Team</h3>
            <h4 className="vertical-timeline-element-subtitle">Pentair - Golden Valley, MN</h4>
            <p>
              Data Modeling, Power PI, Relational Data Models, Microsoft Fabric
            </p>
          </VerticalTimelineElement>
          <VerticalTimelineElement
            className="vertical-timeline-element--work"
